            ...
            <div class="card  d-flex align-items-center p-3 colorForm">
                ...
                <form class="w-100" action="authentication.php" method="POST">
                    ...
                    <div class="w-100 d-flex flex-column d-flex align-items-center">
                        <input class="rounded w-100 ps-1" placeholder="email" type="email" name="username" id="username" required>
                    </div>
                    <label for="password">Mot de passe</label>
                    <div class="w-100 d-flex flex-column d-flex align-items-center">
                        <input class="rounded w-100 ps-1" placeholder="mot de passe" type="password" minlength="8" name="password" id="password" required>
                    </div>
                    <div class="d-flex flex-column d-flex align-items-center">
                        <a class="fs-6" href="recuperationPwd.php">Récupérer mon mot de passe...</a>
